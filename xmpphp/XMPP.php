...
class XMPPHP_XMPP extends XMPPHP_XMLStream {
	...
	public function message($to, $body, $type = 'chat', $subject = null, $payload = null) {
		...
		$out .= "<body>Lo siento pero tu cliente xmpp no soporta nuestras notificaciones.</body><html xmlns='http://jabber.org/protocol/xhtml-im'><body xmlns='http://www.w3.org/1999/xhtml'>$body</body></html>";
